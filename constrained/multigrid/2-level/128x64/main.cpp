...
// Multi grid cycle
Eigen::VectorXf SpaceTimeMultigrid(Eigen::VectorXf w_old, Eigen::VectorXf f, int n, int i, float mu, Eigen::VectorXf u_old, float u_a, float u_b){
...
int main(){
    ...
    remove("w.txt");
    Eigen::VectorXf w = SpaceTimeMultigrid(w_old, f, n, i, mu, u_old, u_a, u_b);
    WriteFile(w, "w");
